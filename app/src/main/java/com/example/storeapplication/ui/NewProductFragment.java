...
import com.example.storeapplication.databinding.FragmentNewProductBinding;


public class NewProductFragment extends Fragment {
    FragmentNewProductBinding fragmentNewProductBinding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentNewProductBinding = DataBindingUtil.inflate(getLayoutInflater(),R.layout.fragment_new_product,container,false);
    ...
    private void setupNavigation(View view){
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(R.id.newProductFragment).setOpenableLayout(mainActivity.drawerLayout).build();
        ...
        navController.addOnDestinationChangedListener(new NavController.OnDestinationChangedListener() {
            ...
            public void onDestinationChanged(@NonNull NavController controller, @NonNull NavDestination destination, @Nullable Bundle arguments) {
                if (destination.getId() == R.id.newProductFragment){
