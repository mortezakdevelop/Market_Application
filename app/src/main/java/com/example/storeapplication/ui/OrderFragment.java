...
import com.example.storeapplication.databinding.FragmentOrderBinding;
...
public class OrderFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentOrderBinding = DataBindingUtil.inflate(getLayoutInflater(),R.layout.fragment_order,container,false);
    ...
    private void setupNavigation(View view){
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(R.id.orderFragment).setOpenableLayout(mainActivity.drawerLayout).build();
        ...
        navController.addOnDestinationChangedListener(new NavController.OnDestinationChangedListener() {
            ...
            public void onDestinationChanged(@NonNull NavController controller, @NonNull NavDestination destination, @Nullable Bundle arguments) {
                if (destination.getId() == R.id.orderFragment){
