...
import com.example.storeapplication.databinding.FragmentOfferBinding;
...
public class OfferFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        fragmentOfferBinding = DataBindingUtil.inflate(getLayoutInflater(),R.layout.fragment_offer,container,false);
    ...
    private void setupNavigation(View view){
        ...
        AppBarConfiguration appBarConfiguration = new AppBarConfiguration.Builder(R.id.offerFragment).setOpenableLayout(mainActivity.drawerLayout).build();
        ...
        navController.addOnDestinationChangedListener(new NavController.OnDestinationChangedListener() {
            ...
            public void onDestinationChanged(@NonNull NavController controller, @NonNull NavDestination destination, @Nullable Bundle arguments) {
                if (destination.getId() == R.id.offerFragment){
